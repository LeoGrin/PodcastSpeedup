...
def refresh(podcasts_df_file):
    ...
    for index, podcast in podcasts_df.iterrows():
        ...
        podcast_db = "download_and_upload/podcasts/podcasts_db/{}.csv".format(podcast.short_name)
...
if __name__ == """__main__""":
    podcast_df_file = "download_and_upload/podcasts/podcasts_db/all_podcasts_db.csv"
